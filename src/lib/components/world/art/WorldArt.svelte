<script lang="ts">
	...
	import Greenbelt from './Greenbelt.svelte';
	import House from './House.svelte';
	import Ipal from './Ipal.svelte';
...
>
	<defs>
		<radialGradient id="world-shadow">
			<stop offset="0" stop-color={worldPalette.outline} stop-opacity="0.2" />
